...
def discriminator_loss(logits_real, logits_fake):
  ...
  loss_real=nn.functional.binary_cross_entropy_with_logits(logits_real,label_real)
  loss_fake=nn.functional.binary_cross_entropy_with_logits(logits_fake,label_fake)
...
def build_dc_classifier():
  ...
  ############################################################################
  # Replace "pass" statement with your code
  model=nn.Sequential(nn.Unflatten(1,(1,28,28),),
